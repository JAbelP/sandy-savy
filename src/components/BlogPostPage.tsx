...
function BlogPostPage({ title, imageUrl, contentFirstHalf }:{BlogPostPageProps}) {
    ...
    return (
        <div className="min-h-screen bg-[#F3F4F6] py-12 px-4 sm:px-6 lg:px-8">
          ...
          <Markup  className="prose max-w-none text-gray-700" content={contentFirstHalf}  />
